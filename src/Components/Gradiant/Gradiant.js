        ...
        <>
            <div className='gridient-div'>
                ...
                <div className="big-button-container">
                    <Link to="/Flat">  <button className="big-button">Flat</button></Link>
                    <button className="big-button">House</button>
                    <button className="big-button">Secondary Unit</button>
                    <button className="big-button">Unique Space</button>
                    <button className="big-button">Bed and Breakfast</button>
                    <button className="big-button">Boutique Hotel</button>
                </div>
            </div>
        </>
